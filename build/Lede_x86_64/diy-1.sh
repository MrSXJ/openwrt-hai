...
svn co https://github.com/project-openwrt/openwrt/trunk/package/ctcgfw package/lean/package
svn co https://github.com/project-openwrt/openwrt/trunk/package/ctcgfw/luci-app-dockerman package/lean/luci-app-dockerman
